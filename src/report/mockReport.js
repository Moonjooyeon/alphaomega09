export function localMockReport(subjects, solo) {
  ...
  return {
    ...
    prognosis: {
      phase_1: "첫 균열은 접촉보다 회피에서 먼저 보인다. 한쪽이 지나간 복도에 다른 쪽의 보폭이 정확히 반 박자 늦게 겹친다.",
      phase_2: "도발한 쪽은 가볍게 물러나지만, 늦게 따라붙는 쪽은 문고리에 남은 체온을 지나치지 못한다.",
      phase_3: "방치 시 둘은 헤어진 자리보다 돌아오기 직전의 침묵에 더 오래 묶인다. 끝까지 아닌 척한 쪽이 결국 상대의 향이 남은 물건을 먼저 치우지 못한다.",
    },
