export const SITES = {
  ...
  IF: { name: "약지 안쪽", meaning: "반지처럼 남지만 장식이 아니라 맥박보다 은밀한 계약이다. 손을 숨길수록 먼저 의식된다." },
  EL: { name: "팔꿈치 안쪽", meaning: "스스로 접어 감출 수 있는 자리. 방어 자세를 취할수록 더 깊이 접혀 반응이 고인다." },
  SH: { name: "어깨선", meaning: "기대거나 밀어낸 흔적이 남는 자리. 멀쩡히 선 척해도 무게중심이 먼저 기운다." },
  SP: { name: "척추선", meaning: "등을 곧게 세울수록 더 길게 드러나는 자리. 통제를 자랑하는 개체일수록 한 줄로 무너진다." },
  WA: { name: "허리 뒤", meaning: "붙잡힌 적 없다고 말하기 어려운 자리. 한 손이 닿았던 방향으로 몸이 먼저 돌아간다." },
  KN: { name: "무릎 뒤", meaning: "버티는 척 서 있어도 힘이 빠지는 지점이다. 도망보다 주저앉는 반응이 먼저 기록된다." },
  JA: { name: "턱 아래", meaning: "고개를 들거나 숙이는 선택이 동시에 들키는 자리. 시선보다 복종과 반항이 먼저 갈린다." },
  SL: { name: "목 아래 그림자", meaning: "목덜미도 쇄골도 아닌 애매한 경계다. 끝까지 숨기려던 숨의 방향만 선명하게 남는다." },
};
...
export const QUESTIONS = [
  ...
  { id: "a_surface", q: "개체 A가 개체 B를 대하는 이성적 태도는?", o: ["자동", "철저한 무관심", "통제와 억압", "다정함", "노골적 혐오"] },
  { id: "a_instinct", q: "개체 A의 본능적 반응은?", o: ["자동", "맹목적 발정", "지독한 안도감", "파괴적 소유욕", "강제적 굴복"] },
  { id: "b_surface", q: "개체 B가 개체 A를 대하는 이성적 태도는?", o: ["자동", "철저한 무관심", "통제와 억압", "다정함", "노골적 혐오"] },
  { id: "b_instinct", q: "개체 B의 본능적 반응은?", o: ["자동", "맹목적 발정", "지독한 안도감", "파괴적 소유욕", "강제적 굴복"] },
  { id: "relation_tone", q: "관계 결은 어느 쪽에 가까운가?", o: ["자동", "순애", "혐관", "순애인데 숨김", "혐관인데 못 놓음", "겉으론 비즈니스"] },
];
